		...
		<>
			{toggle ? (
				<div className="top-0 left-0 right-0 bottom-0 z-20 w-full h-full fixed bg-black bg-opacity-50 flex justify-center items-center">
					<div
						className="rounded-md fixed w-3/4 h-5/6  bg-white shadow-md relative z-10 rounded-sm overflow-auto"
					...
					>
						...
						<div className="mt-4 ml-4 font-mono text-3xl flex flex-col justify-center items-left text-black">
